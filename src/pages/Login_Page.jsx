  ...
  return (
    ...
    <div className='wrapper'>
      ...
      <div className='signUpbox'>
        <Username/>
        <Password/>
        <button onClick={handle_importance} className='glass-button'>Log in</button>
        <div className='NewuserDiv'>
        <p className='NewuserText'>New to GI movies? Signup <Link to="/home" className='NewuserSignupLink'> Here</Link> </p>
